...
console.log('🌱 Seeding Study Hub data...\n');
...
async function seedDailyStats() {
    console.log('📊 Seeding daily stats (10 streams)...');
    const batch = writeBatch(db);
    ...
    console.log(`✅ Added 10 days of stats (~${totalHours.toFixed(1)}h total)\n`);
}

async function seedStudyPlan() {
    console.log('📅 Seeding 10-month study plan...');
    ...
    console.log(`✅ Added study plan (${studyPlanData.months.length} months)\n`);
}
